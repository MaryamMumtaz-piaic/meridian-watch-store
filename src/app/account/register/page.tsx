  ...
  return (
    <div className="flex h-dvh items-center justify-center overflow-hidden px-4 py-3">
      <div
        ...
        style={{ borderRadius: "1.25rem", boxShadow: "0 4px 32px rgba(28,25,23,0.07), 0 1px 4px rgba(28,25,23,0.04)", height: "calc(100dvh - 1.5rem)", maxHeight: "calc(100dvh - 1.5rem)" }}
      >
        <div className="flex h-full w-full min-h-0">
          {/* ── Left branded panel ── */}
          <div
            className="relative hidden min-h-0 flex-col overflow-hidden md:flex md:w-[42%]"
          ...
          >
            ...
            {/* Brand copy */}
            <div className="relative z-10 p-8 pb-2">
              <span
            ...
            {/* Brand illustration */}
            <div className="relative z-10 mt-auto min-h-0 flex-shrink overflow-hidden" style={{ maxHeight: "52%" }}>
              <Image
          ...
          {/* ── Right form panel ── */}
          <div className="flex min-h-0 flex-1 flex-col overflow-y-auto px-8 py-6 md:px-12">
          <div className="my-auto w-full">
            ...
            <div className="mt-4 grid grid-cols-3 gap-3">
              <button
                ...
                className="flex items-center justify-center border border-hairline bg-white py-3 text-foreground transition-all hover:border-gold hover:shadow-sm focus-visible:border-gold focus-visible:outline-none"
                style={{ borderRadius: "8px" }}
              ...
              <button
                type="button"
                className="flex items-center justify-center border border-hairline bg-white py-3 text-foreground transition-all hover:border-[#1877F2] hover:shadow-sm focus-visible:outline-none"
                style={{ borderRadius: "8px" }}
              ...
              <button
                type="button"
                className="flex items-center justify-center border border-hairline bg-white py-3 text-foreground transition-all hover:border-foreground hover:shadow-sm focus-visible:outline-none"
                style={{ borderRadius: "8px" }}
